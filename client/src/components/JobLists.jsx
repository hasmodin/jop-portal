    ...
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
      ...
      <div className="w-full lg:w-1/4 bg-white px-4">
          ...
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              ...
              <div className="mb-4 text-gray-600">
                {searchFilter.title && (
                  <span className="inline-flex items-center gap-2.5 bg-blue-200 border border-blue-200 px-4 py-1.5 rounded">
                    {searchFilter.title}
                    <img
                      onClick={() =>
                ...
                {searchFilter.location && (
                  <span className=" ml-2 inline-flex items-center gap-2.5 bg-red-200 border border-red-200 px-4 py-1.5 rounded">
                    {searchFilter.location}
                    <img
                      onClick={() =>
                        setSearchFilter((prev) => ({
        ...
        <button
          ...
          className="border border-gray-200 px-4 py-1.5 rounded lg:hidden"
        >
        ...
        {/* location filter */}
        <div className={showFilter ? "" : "max-lg:hidden"}>
          <h4 className="font-medium text-lg py-4 mt-14">
            Search by Locations
          </h4>
          <ul className="space-y-4 text-gray-600">
